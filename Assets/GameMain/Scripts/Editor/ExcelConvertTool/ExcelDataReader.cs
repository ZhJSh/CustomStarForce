...
namespace StarForce.Editor.DataTableTools
{
    public class ExcelDataReader
    {
        ...
        //Excel第2行对应字段名称
        private const int excelNameRow = 1;

        //Excel第3行对应字段类型
        private const int excelTypeRow = 2;

        //Excel第4行对应中文说明
        private const int excelNodeRow = 3;
        ...
        public static void ReadOneExcelToCode(string excelFullPath, string codeSavePath)
        {
            ...
            //根据数据生成C#脚本
            //string classCodeStr = ExcelCodeCreator.CreateCodeStrByExcelData(excelMediumData);
