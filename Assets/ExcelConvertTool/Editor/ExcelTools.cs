...
public class ExcelTools : EditorWindow
{
    ...
    /// <summary>
    /// 包含所有Excel文件的列表(实际上是所有Excel文件的绝对路径)
    /// </summary>
    ...
    private void DrawExport()
    {
        ...
        else
        {
            ...
            if (GUILayout.Button("转换"))
            {
                ...
                if (isGenerateCode)
                {
                    ExcelDataReader.ReadAllExcelToCode(excelFullPath, pathCode);
                }
            }
        }
    }
    ...
    private static void Convert()
    {
        ...
        {
            //获取Excel文件的绝对路径
            absolutePath = excelFullPath + CheckEditorPath('/' + assetsPath);
            //构造Excel工具类
            ...
            {
                output = targetDir + assetsPath.Replace(".xlsx", ".csv");
